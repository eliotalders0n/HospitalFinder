...
const TABLE_HEAD = [
  ...
  { id: 'make', label: 'BRAND', alignRight: false },
  { id: 'model', label: 'MODEL', alignRight: false },
  { id: 'year', label: 'YEAR', alignRight: false },
  { id: 'color', label: 'COLOR', alignRight: false },
  { id: 'transmission', label: 'TRANSMISSION', alignRight: false },
  { id: 'fuel', label: 'FUEL', alignRight: false },
    ...
    <Page title="Quotes">
      <Container>
        <Stack direction="row" alignItems="center" justifyContent="space-between" mb={5}>
          <Typography variant="h4" gutterBottom style={{flex:1}}>Cars</Typography>
        ...
        >
          <Link component={RouterLink} style={{textDecoration:"none", }} variant="subtitle2" to="/addCar"  >
           Add Vehicle
          </Link></Button>
      ...
      <Card sx={{p:3}}>
        ...
        <Typography variant='h5'>{USERLIST && USERLIST.filter(item => item.status === "ONLINE").length}</Typography>
        </div>
        <div>
        <Typography variant='overline'>Total Offline</Typography>
        <Typography variant='h5'>{USERLIST && USERLIST.filter(item => item.status === "OFFLINE").length}</Typography>
        </div>
        <div>
        ...
        <div>
        <Typography variant='overline'>Total Cars</Typography>
...
<Stack direction={"row"} spacing={3} >
    ...
    <Button variant={selectedFilter === "Online" ? "contained" : "outlined"} onClick={()=>selectItem("Online")}>Online</Button> 
    <Button variant={selectedFilter === "Offline" ? "contained" : "outlined"} onClick={()=>selectItem("Offline")}>Offline</Button> 
                    ...
                    .map((row) => {                
                      ...
                      return (
                        ...
                        >
                          ...
                          <TableCell align="left"> <Link  to={"/viewCar/"+row.id}
            state={{data:row}}
