...
import useGetQuotations from 'src/hooks/useGetQuotations';
// ----------------------------------------------------------------------
...
export default function Quotations() {
  ...
  let USERLIST = useGetQuotations().docs
    ...
    <Page title="Quotes">
      <Container>
        <Stack direction="row" alignItems="center" justifyContent="space-between" mb={5}>
          <Typography variant="h4" gutterBottom style={{flex:1}}>Quotations</Typography>    
         
          <Link  to={"/addNewBooking/"}   state={{type:"Q"}}> <Button
          sx={{marginRight:2}}
          size="small"
          type="submit"
          color='success'
      ...
      <Card sx={{p:3}}>
        ...
        <div>
        <Typography variant='overline'>Total Quotations</Typography>
              ...
              <Table>
                ...
                <TableBody>
                  {filteredUsers
                    ...
                    .map((row) => {
                      const { id, name, car_id, extras,status, totalAmount, numberOfDays } = row;                                           return (
                        <TableRow
                          hover
                          key={id}
                          tabIndex={-1}
                        ><TableCell align="left"> {name}</TableCell>
                          ...
                          <TableCell align="left">{parseFloat(extras).toFixed(2)}</TableCell>
